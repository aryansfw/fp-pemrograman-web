<x-app-layout>
    ...
    <div class="row ms-4 mt-4">
        ...
        <div class="col-md-3">
            <div class="card" style="width: 18rem">
                <img
                    src="{{ asset(str_replace('public', 'storage', $event->e_image)) }}"
                    class="card-img-top"
                    alt="..."
                />
                <div class="card-body">
                    <h5 class="card-title">
                        <a
                            ...
                            href="{{ route('event.geteventdetail', ['group_id' => $event->g_id, 'event_id' => $event->e_id]) }}"
                            >{{$event->e_name}}</a
                        >
                    </h5>
                    ...
                    <p>
                        ...
                        >{{ date('d M Y H:i:s', strtotime($event->e_date)) }}
                    </p>
    ...
    <a
        ...
        href="{{ route('group.getcreate') }}"
        role="button"
        >Buat grup baru <i class="bi bi-plus-circle"></i>
    </a>
                ...
                <div class="col-md-3">
                    <div class="card" style="width: 18rem">
                        <div class="card-body">
                            ...
                            <div class="float-end">
                                <a
                                    href="{{ route('group.getgroupbyid', ['group_id' => $group->g_id])}}"
                                    class="btn"
                                    style="
                                        text-decoration: underline;
                                        text-decoration-color: #7879df;
